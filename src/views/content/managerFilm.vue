...
<template>
  ...
  <el-form-item label="电影海报">
    ...
    action="localhost:8090/movie/img/upload"
    :on-remove="handleRemove"
    :on-change="changeImgFileSize"
    :file-list="fileList"
    :auto-upload="false"
    :on-exceed="overLimit">
    <div>
...
export default {
  ...
  methods: {
    ...
    submitFilmFormDate(){
        this.$axios.post("/movie/add",this.form)
        .then((res)=>{
            console.log(res)
